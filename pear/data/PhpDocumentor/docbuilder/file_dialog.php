...
if ('/usr/share/pear/data' != '@'.'WEB-DIR@')
{
    /**
    ...
    */
    ...
    require_once( '/usr/share/pear/data' . PATH_DELIMITER . 'PhpDocumentor/docbuilder/includes/utilities.php' );
    ...
    $ini = phpDocumentor_parse_ini_file('/usr/share/pear/data' . PATH_DELIMITER . 'PhpDocumentor/phpDocumentor.ini', true);
    if (isset($ini['_phpDocumentor_options']['userdir'])) {
        $configdir = $ini['_phpDocumentor_options']['userdir'];
    } else {
        $configdir = '/usr/share/pear/data' . PATH_DELIMITER . 'PhpDocumentor/user';
    }
} else {
