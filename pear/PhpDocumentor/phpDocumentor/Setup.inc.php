...
class phpDocumentor_setup
{
    ...
    function readConfigFile($file)
    {
        ...
        {
            if ('/usr/share/pear/data' != '@'.'DATA-DIR@')
            {
                $configdir = str_replace('\\','/', '/usr/share/pear/data/PhpDocumentor') . PATH_DELIMITER . 'user' . PATH_DELIMITER;
            } else {
    ...
    function parseIni()
    {
        ...
        if ('/usr/share/pear/data' != '@'.'DATA-DIR@')
        {
            $options = phpDocumentor_parse_ini_file(str_replace('\\','/', '/usr/share/pear/data/PhpDocumentor') . PATH_DELIMITER . 'phpDocumentor.ini',true);
            phpDocumentor_out("   (found in " . '/usr/share/pear/data/PhpDocumentor' . PATH_DELIMITER . ")...\n");
        } else {
