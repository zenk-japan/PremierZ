		...
		<div id="id_div_main_top">
			...
			<table id="id_table_search">
				...
				<td class="c_td_search">
					<input type="text" id="id_dsp_src_data_id" style="width:10em" class="c_disp_search" value="{$dsp_src_data_id}" readOnly="true" />
					<select id="id_sel_src_dataid" class="c_sel_search" style="width:10em">
					{foreach from=$ar_data_id item=data_id_item}
						<option value="{$data_id_item.value}" {$data_id_item.selected}>{$data_id_item.caption}</option>
					{/foreach}
					</select>
				</td>
				</tr>
				<tr class="c_tr_search">
				<td class="c_td_search">
					<input type="text" style="width:10em" class="c_disp_search" value="{$dsp_src_fromto_cap}" readOnly="true" />
					<input type="text" id="id_dsp_src_from" style="width:5em" class="c_disp_search" value="{$dsp_src_from}" readOnly="true" />
					<input type="text" id="id_txt_src_from" style="width:15em" class="c_text_search" value="{$txt_src_from}" />
					<span class="c_span_search">&nbsp;&gt;&gt;&nbsp;</span>
					<input type="text" id="id_dsp_src_to" style="width:5em" class="c_disp_search" value="{$dsp_src_to}" readOnly="true" />
					<input type="text" id="id_txt_src_to" style="width:15em" class="c_text_search" value="{$txt_src_to}" />
				</td>
				</tr>
				<tr class="c_tr_search">
				<td class="c_td_search">
				...
				<tr class="c_tr_search">
				<td class="c_td_search">
					<input type="text" id="id_dsp_src_purpose" style="width:10em" class="c_disp_search" value="{$dsp_src_purpose}" readOnly="true" />
					<select id="id_sel_src_purpose" class="c_sel_search" style="width:15em">
					{foreach from=$ar_purpose item=purpose_item}
						<option value="{$purpose_item.value}" {$purpose_item.selected}>{$purpose_item.caption}</option>
					{/foreach}
					</select>
				</td>
				</tr>
				<tr class="c_tr_search">
				<td class="c_td_search">
					<input type="text" id="id_dsp_src_title" style="width:10em" class="c_disp_search" value="{$dsp_src_title}" readOnly="true" />
					<input type="text" id="id_txt_src_title" style="width:40em" class="c_text_search" value="{$txt_src_title}" />
				</td>
				</tr>
				<tr class="c_tr_search">
				<td class="c_td_search">
