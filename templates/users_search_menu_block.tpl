	...
	<div id="id_div_search_menu">
		...
		<table id="id_table_search">
			...
			<tr>
				...
				<td class="c_td_search_input">
					<input title="ダブルクリックでリスト表示" id="id_txt_cond_group_name" size ="30" name="GROUP_NAME" title="" type="text" value="{$cond_group_name}" class="c_txt_search_textbox c_txt_search_textbox_vl" />
				</td>
			</tr>
			<tr>
				<td class="c_td_serch_text">
				...
				<td class="c_td_search_input">
					<input id="id_txt_cond_user_name" size ="30" name="USER_NAME" title="" type="text"  value="{$cond_user_name}" class="c_txt_search_textbox" />
				</td>
			</tr>
		</table>
		{* ボタン *}
