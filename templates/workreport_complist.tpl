		...
		<div id="id_div_main_menu">
			<table id="id_table_main_menu">
				<tr>
					...
					<td id="id_td_mainmenu_workcomplist" class="c_td_main_menu_selector_now">
...
<!--	<DIV>-->
	...
	<div id="id_div_workreport_top_table">
		<table id="id_table_workreport_top_list">
	...
	<div id="id_div_workreport_table">
		<table id="id_table_workreport_list">
			{foreach from=$ar_workstaff key=row_num item=row_rec name=ar_workstaff_menu}
			<tr class="c_tr_list_menu">
				...
				<td class="c_td_list_menu_work_base">
					{$row_rec.WORK_BASE_NAME}
				</td>
				<td class="c_td_list_menu_detail">
					<input type="button" class="c_btn_list_menu_detail" id="id_btn_list_menu_detail{$smarty.foreach.ar_workstaff_menu.iteration}" value="詳細画面" />
					<input type="hidden" id = "id_workstaffid_list_menu{$smarty.foreach.ar_workstaff_menu.iteration}" value="{$row_rec.WORK_STAFF_ID}" />
				</td>
			</tr>
			{foreachelse}
			<tr><td colspan=4>該当作業は有りません。</td></tr>
			{/foreach}
		</table>
	</div>
	<!-- コピーライト -->
